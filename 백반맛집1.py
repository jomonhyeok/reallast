      ...
      <div class="nav_item">검색</div>
       ...
       <div class="title_not">
        ...
        <div class="list">
            ...
            <div class="foodlist">
                ...
                <div class="info">
                    ...
                    <div class="mainmenu">{mainmenu4}</div>
            ...
            <div class="foodlist">
                ...
                <div class="info">
                    ...
                    <div class="mainmenu">{mainmenu6}</div>
            ...
            <div class="foodlist">
                ...
                <div class="info">
                    ...
                    <div class="mainmenu">{mainmenu7}</div>
            ...
            <div class="foodlist">
                ...
                <div class="info">
                    ...
                    <div class="mainmenu">{mainmenu8}</div>
            ...
            <div class="foodlist">
                ...
                <div class="info">
                    ...
                    <div class="mainmenu">{mainmenu9}</div>
        ...
        <div class="page_button">
            <a href="백반맛집1.py"><button class="ui brown button">1</button></a>
            <a href="백반맛집2.py"><button  class="ui brown basic button">2</button></a>
            <button class="ui brown basic button">3</button>
            <button class="ui brown basic button">4</button>
            <button class="ui brown basic button">5</button>
        </div>
    </body>
    </html>
