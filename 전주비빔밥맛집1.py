...
url = 'http://openapi.jeonju.go.kr/rest/jeonjufood/getMimbapList'
      ...
      <div class="nav_item">검색</div>
       ...
       <div class="title_not">
        ...
        <div class="list">
            ...
            <div class="foodlist">
                <img class="foodimg" src={mainimgurl3}  width= "190px" height="130px" >
                <div class="info">
            ...
            <div class="foodlist">
                ...
                <div class="info">
                    ...
                    <div class="mainmenu">전주비빔밥, 갈비전골, 불낙전골, 육회</div>
            ...
            <div class="foodlist">
                ...
                <div class="info">
                    ...
                    <div class="tel5">전북 전주시 덕진구 기린대로 425</div>
