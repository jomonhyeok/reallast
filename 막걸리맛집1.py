...
url = 'http://openapi.jeonju.go.kr/rest/jeonjufood/getKoreaWineList'
      ...
      <div class="nav_item">검색</div>
       ...
       <div class="title_not">
        ...
        <div class="list">
            ...
            <div class="foodlist">
                <img class="foodimg" src={mainimgurl4} height="130px" >
                <div class="info">
