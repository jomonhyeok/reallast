...
<body>
  ...
  <div class="side">
      <h1><a href="index.py">수정하기</a></h1>
      <form action="process_update.py" method="post">
          <input type="hidden" name="pageId" value="{form_default_title}">
          <p><input type="text" name="title" placeholder="title" style="width:1000px;" value="{form_default_title}"></p>
          <p><textarea rows="18" name="description" placeholder="description" style="width:1000px;">{form_default_description}</textarea></p>
          <div class="create_button"><p><button type="submit" class="btn btn-primary">수정하기</button></p></div>
      </form>
  </div>
</body>
</html>
'''.format(title=pageId, desc=description, form_default_title=pageId, form_default_description=description))
